...
import { Paperclip, Upload, X, FileText, Image, File, Download, Trash2, Loader2 } from "lucide-react";
...
export const TaskAttachments = ({ taskId, canEdit = true }: TaskAttachmentsProps) => {
  const { user } = useAuth();
